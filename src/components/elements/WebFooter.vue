...
<template>
    <div class="block md:flex justify-between pb-10 bg-[#140E3A]">
        <div class="my-20 mx-5 text-center md:text-left">
            <img src="../../assets/icons/spartak_main_logo.svg" alt="logo" class="mx-auto md:mx-0">
            <p class="pt-6">the leading NFT Marketplace on Ethereum <br>
